import{j as l}from"./jsx-runtime-DGop6S_Y.js";import{r as x}from"./index-C3JiJ1qr.js";import{c as v}from"./index-DdzbqoOO.js";const _="_segmentedControl_cbve4_1",k="_option_cbve4_16",W="_active_cbve4_44",q="_disabled_cbve4_54",o={segmentedControl:_,option:k,active:W,disabled:q},E=[{label:"Workwear",value:"workwear"},{label:"Casual",value:"casual"},{label:"Formal",value:"formal"},{label:"Gym",value:"gym"}];function m({options:a=E,value:c="workwear",onChange:n,className:r}){const t=(e,s)=>{s||n&&n(e)};return l.jsx("div",{className:v(o.segmentedControl,r),children:a.map(e=>{const s=e.value===c;return l.jsx("button",{type:"button",className:v(o.option,{[o.active]:s,[o.disabled]:e.disabled}),onClick:()=>t(e.value,e.disabled),disabled:e.disabled,"aria-pressed":s,children:e.label},e.value)})})}m.__docgenInfo={description:"",methods:[],displayName:"SegmentedControl",props:{options:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
  /**\r
...
}`,...(C=(w=u.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};const O=["Interactive","ManyOptions","WithDisabled"];export{i as Interactive,d as ManyOptions,u as WithDisabled,O as __namedExportsOrder,A as default};
