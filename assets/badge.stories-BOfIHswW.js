import{j as r}from"./jsx-runtime-DGop6S_Y.js";import{B as a}from"./badge-LIqnf4bc.js";import{A as O}from"./avatar-CdfXzoRV.js";import"./index-C3JiJ1qr.js";import"./index-DdzbqoOO.js";const E={title:"Data Display/Badge",component:a,tags:["autodocs"],argTypes:{variant:{control:"select",options:["primary","secondary","success","danger","warning"]},size:{control:"radio",options:["sm","md"]},content:{control:"text"},isDot:{control:"boolean"},max:{control:"number"}}},e={args:{content:"New",variant:"primary"}},s={args:{content:120,max:99,variant:"danger"}},t={render:()=>r.jsxs("div",{style:{display:"flex",gap:"10px"},children:[r.jsx(a,{content:"Primary",variant:"primary"}),r.jsx(a,{content:"Secondary",variant:"secondary"}),r.jsx(a,{content:"Success",variant:"success"}),r.jsx(a,{content:"Danger",variant:"danger"}),r.jsx(a,{content:"Warning",variant:"warning"})]})},n={args:{isDot:!0,variant:"success"}},o={render:i=>r.jsx(a,{...i,children:r.jsx(O,{src:"https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100",size:"lg"})}),args:{content:5,variant:"danger",size:"md"}},c={render:i=>r.jsx(a,{...i,children:r.jsx("div",{style:{width:"48px",height:"48px",backgroundColor:"#ddd",borderRadius:"8px"}})}),args:{isDot:!0,variant:"success",size:"sm"}};var d,p,g;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    content: 'New',
    variant: 'primary'
  }
}`,...(g=(p=e.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var m,u,l;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    content: 120,
    max: 99,
    variant: 'danger'
...
}`,...(z=(A=c.parameters)==null?void 0:A.docs)==null?void 0:z.source}}};const P=["Default","NotificationCount","AllVariants","StatusDot","OverlapOnAvatar","OnlineStatus"];export{t as AllVariants,e as Default,s as NotificationCount,c as OnlineStatus,o as OverlapOnAvatar,n as StatusDot,P as __namedExportsOrder,E as default};
