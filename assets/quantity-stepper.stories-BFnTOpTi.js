import{j as C}from"./jsx-runtime-DGop6S_Y.js";import{r as R}from"./index-C3JiJ1qr.js";import{Q as b}from"./quantity-stepper-t1RCsGgE.js";import"./index-DdzbqoOO.js";import"./iconify-BsDr7Yem.js";const V={title:"E-commerce/QuantityStepper",component:b,tags:["autodocs"],argTypes:{value:{control:{type:"number"}},min:{control:{type:"number"}},max:{control:{type:"number"}},disabled:{control:"boolean"},onChange:{action:"changed"}}},e={render:s=>{const[S,y]=R.useState(s.value??1);return C.jsx(b,{...s,value:S,onChange:t=>{y(t),s.onChange(t)}})},args:{value:1,min:1,max:10}},a={args:{value:5,disabled:!0}},r={args:{value:1,min:1}},n={args:{value:99,max:99}};var o,c,m;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: args => {
...
}`,...(h=(x=n.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};const D=["Interactive","Disabled","MinReached","MaxReached"];export{a as Disabled,e as Interactive,n as MaxReached,r as MinReached,D as __namedExportsOrder,V as default};
